...
export const LinkPreview = ({
  ...
  const handleMouseMove = (event: any) => {
    ...
    const eventOffsetY = event.clientY - (targetRect.top) - targetRect.height / 2.5;
    ...
    if (rightColumn && previewRef.current) {
      ...
      const maxOffsetRight = containerRect.right - previewCenterX - previewRect.width / 2;
      
      const maxOffsetDown = targetRect.top - previewCenterY - previewRect.height / 2;
