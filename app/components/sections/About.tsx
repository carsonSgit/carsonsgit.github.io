      ...
      <div className="AboutContentContainer">
        <div className="AboutContent">
          <p className='AboutText'>
            ...
            During my free time, I'm probably <i>at</i> or <i>waiting</i> for a {" "}
            <LinkPreview url="https://devpost.com/carsonSgit?ref_content=user-portfolio&ref_feature=portfolio&ref_medium=global-nav"
            className="hoverLink">
            <span id="status">hackathon</span>
            </LinkPreview> {" "}
            to attend. 
            Throughout the 8+ years I've been coding, I've made some pretty {" "}
            <LinkPreview url="https://github.com/carsonSgit"
            className="hoverLink">
            <span id="hint">cool projects</span>
            </LinkPreview> {" "}, and I'm always working on improving and learning more.
          </p>
        </div>
      </div>
    </motion.div>
