      ...
      <div className="AboutContentContainer">
        <div className="AboutContent">
          <p className='AboutText'>
            I'm a CS student @ <a className="hoverLink" id="cU" href="https://www.concordia.ca" target="_blank" rel="noreferrer">Concordia University</a> and a CS alumni from <a className="hoverLink" id="jac" href="https://johnabbott.qc.ca/career-programs/computer-science-technology/computer-science-420-b0/" target="_blank" rel="noreferrer">John Abbott College</a>. 
